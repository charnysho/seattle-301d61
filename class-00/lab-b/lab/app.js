...
let sumAndProduct = (num1, num2) => [num1 + num2, num1 * num2];
...
// `this` in scope() function represented a joe object
// `this` in scopeArrow() function represented a global window object
